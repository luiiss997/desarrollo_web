...
public class ProveedoresFacade extends AbstractFacade<Proveedores> {
    ...
    public ProveedoresFacade() {
     ...
     public List<Proveedores> listaActivos(){
        Query consulta = em.createNamedQuery("Proveedores.findActive",Proveedores.class);
     ...
     public List<Proveedores> listaEliminados(){
        Query consulta = em.createNamedQuery("Proveedores.findDelated",Proveedores.class);
        List<Proveedores> lista = consulta.getResultList();
        if(!lista.isEmpty()){
            return lista;
        }else{
