...
@NamedQueries({
    ...
    , @NamedQuery(name = "Ventas.findActive", query = "SELECT v FROM Ventas v WHERE v.status = 1")
    , @NamedQuery(name = "Ventas.findDelated", query = "SELECT v FROM Ventas v WHERE v.status = 0")
