...
@NamedQueries({
    ...
    , @NamedQuery(name = "Compras.findActive", query = "SELECT c FROM Compras c WHERE c.status = 1")
    , @NamedQuery(name = "Compras.findDelated", query = "SELECT c FROM Compras c WHERE c.status = 0")
...
public class Compras implements Serializable {
    ...
    public String toString() {
        return "ID: "+id+" - Usuario Que compro: "+idUsuario;
    }
