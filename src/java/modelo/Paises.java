...
@NamedQueries({
    ...
    , @NamedQuery(name = "Paises.findActive", query = "SELECT p FROM Paises p WHERE p.status = 1")
    , @NamedQuery(name = "Paises.findDelated", query = "SELECT p FROM Paises p WHERE p.status = 0")
