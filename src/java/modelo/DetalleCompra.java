...
@NamedQueries({
    ...
    , @NamedQuery(name = "DetalleCompra.findActive", query = "SELECT d FROM DetalleCompra d WHERE d.status = 1")
    , @NamedQuery(name = "DetalleCompra.findDelated", query = "SELECT d FROM DetalleCompra d WHERE d.status = 0")
