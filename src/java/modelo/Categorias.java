...
@NamedQueries({
    ...
    , @NamedQuery(name = "Categorias.findActive", query = "SELECT c FROM Categorias c WHERE c.status = 1")
    , @NamedQuery(name = "Categorias.findDelated", query = "SELECT c FROM Categorias c WHERE c.status = 0")
